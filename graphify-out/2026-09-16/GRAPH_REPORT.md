...
## Corpus Check
- 167 files · ~343,301 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 17 file(s) not represented in the graph (top: (none) 6, .woff2 5, .css 3)

## Summary
- 928 nodes · 1548 edges · 69 communities (56 shown, 7 thin omitted)
...
Cohesion: 0.06
Nodes (49): ADR-0003, ADR-0004, astro, fadedEnd, fadeInEnd, slides, visibleEnd, present (+41 more)

### Community 6 - "i18n/config.ts"
Cohesion: 0.17
Nodes (7): pages, defaultLocale, localeName, locales, localeShort, ogLocale, heading

### Community 7 - "utils.ts"
Cohesion: 0.14
Nodes (12): resolved, html, picked, caption, isLocale(), alternatePath(), dateLocale, formatNumber() (+4 more)
...
Cohesion: 0.09
Nodes (21): name, pullQuote, title, quote, role, AllocationItem, BankAccount, CmsAsset (+13 more)
...
Cohesion: 0.18
Nodes (18): ADR-0007, fetchOr(), getDirectorMessage(), getImpactStats(), getJob(), getJobs(), getOrgChart(), getPage() (+10 more)
...
### Community 24 - "t"
Cohesion: 0.15
Nodes (7): items, jsonLd, Crumb, t(), serializeJsonLd(), policies, policies
...
### Community 40 - "ReportsPage.astro"
Cohesion: 0.14
Nodes (6): formatFileSize(), tPick(), partnerCategoryLabels, reportTypeLabels, groups, heading
...
### Community 44 - "JobPost"
Cohesion: 0.40
Nodes (3): JobPost, { job }, { job }
...
Cohesion: 0.17
Nodes (12): isCurrent(), Locale, en, km, ui, UIKey, Picked, footerNav (+4 more)
...
## Knowledge Gaps
- **492 isolated node(s):** `env`, `failures`, `SITE`, `Env`, `FunctionContext` (+487 more)
